  ...
  <nav class="navbar navbar-expand">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/shop/departments/1">Chairs</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/shop/departments/2">Stools</a>
          </li>
      </ul>
      <ul class="navbar-nav">
        <li class="nav-item active"><a class="nav-link" href="/shop/basket">Basket</a></li>
      </ul>
          @if (Route::has('login'))
              <ul class="navbar-nav">
                  @auth
